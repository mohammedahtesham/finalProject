                	...
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('teacher');?></div></th>
                                <th><div><?php echo get_phrase('syllabus');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->crud_model->get_type_name_by_id('teacher',$row['teacher_id']);?></td>
                                                        <td align="center">
                                                            <a data-toggle="modal" href="#modal-form" onclick="modal('view_syllabus',<?php echo $row['subject_id'];?>)" class="btn btn-gray btn-small">
                                		<i class="icon-file-alt"></i> <?php echo get_phrase('View');?>
                                                        </td>
							<td align="center">
                	...
                	<?php echo form_open('admin/subject/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Syllabus');?></label>
                                <div class="controls">
                                    <textarea type="text" class="" name="syllabus" rows="10" cols="20"></textarea>
                                </div>
                            </div>
                        </div>
